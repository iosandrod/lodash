...
export class Resource {
  ...
  private getResource(drResource: any): void {
    ...
    this.cDefine15 = new Date(drResource['cResDefine15'])
    this.cDefine16 = new Date(drResource['cResDefine16'])
    this.cDayPlanShowType = drResource['cDayPlanShowType']
    this.dMaxExeDate = new Date(drResource['dMaxExeDate'])
  }
  GetTaskCanBegDate(
