...
export class SchData {
  ...
  static GetDateDiff(DatePart: string, dt1: Date, dt2: Date, aa: any): any {
  ...
  static GetDateDiffString(Date1: Date, Date2: Date, Interval: string): string {
  ...
  static AddDate(DatePart: string, iAdd: number, dt1: Date): Date {
    let dtNew: Date = new Date(dt1)
    if (DatePart === 's') {
