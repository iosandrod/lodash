...
exports.createInteface = exports.SchInterface = void 0;
const type_1 = require("./type");
const Base_1 = require("./Base");
class SchInterface extends Base_1.Base {
    ...
    async SetInit(input) {
        let ConnectString = input.ConnectString;
    ...
    async Start(input) {
        let SqlPro = this; //
        let cVersionNo = input.cVersionNo;
        let adte_Start = new type_1.DateTime(input.adte_Start);
        let adte_End = new type_1.DateTime(input.adte_End);
        let bShowTips = true;
        let cSchType = input.cSchType;
        let cTechSchType = input.cTechSchType;
        let iCurSchRunTimes = input.iCurSchRunTimes;
        debugger;
        ...
        this.schData.dtToday = new type_1.DateTime(); // Assuming this is the current date
        this.schData.cCalculateNo = `${this.User};${this.schData.dtToday}`;
        console.log(this.schData.dtToday);
        let SchParam = new type_1.SchParam(); //系统参数，实例化，后续都用这个类
        ...
        if (SchParam.bReSchedule !== '1') {
            ...
            this.dlShowProcess(this.schPrecent.toString(), this.message);
            try {
                let lsSql2 = `EXECUTE P_SchedulePrePre '${this.schData.cVersionNo}','${this.schData.dtStart.toString()}','${this.schData.dtEnd.toString()}','${SchParam.cSchType}','${SchParam.cTechSchType}','${this.schData.cCalculateNo}','${SchParam.iCurSchRunTimes}'`;
                await SqlPro.ExecuteNonQuery(lsSql2, null);
                let lsSql = `EXECUTE P_SchedulePre '${this.schData.cVersionNo}','${this.schData.dtStart.toString()}','${this.schData.dtEnd.toString()}','${SchParam.cSchType}','${SchParam.cTechSchType}','${this.schData.cCalculateNo}','${SchParam.iCurSchRunTimes}'`;
        ...
        this.dlShowProcess(this.schPrecent.toString(), this.message);
        try {
            let scheduling = new type_1.Scheduling();
        ...
        this.dlShowProcess(this.schPrecent.toString(), this.message);
        try {
            let lsSql = `EXECUTE P_SchedulePost '${this.schData.cVersionNo}','${this.schData.dtStart.toString()}','${this.schData.dtEnd.toString()}','${this.schData.dtToday.toString()}','${SchParam.cSchType}','${SchParam.cTechSchType}','${this.schData.cCalculateNo}','${SchParam.iCurSchRunTimes}'`;
            await SqlPro.ExecuteNonQuery(lsSql, null);
        }
        catch (excp) {
        ...
        try {
            let lsSql = `EXECUTE P_SchKPI '${this.schData.cVersionNo}','${this.ldtBegDate}','${new type_1.DateTime()}','${this.schData.cCalculateNo}','','${SchParam.cSchType}','${SchParam.cTechSchType}'`;
            await SqlPro.ExecuteNonQuery(lsSql, null);
        }
        catch (excp) {
    ...
    GetResourceList() {
        let SqlPro = this;
        let SchParam = console.log('取生成了资源工作日历的资源列表'); //SchParam 系统参数类
        ...
        try {
            ...
            for (let drWorkCenter of this.schData.dtWorkCenter.rows) {
                ...
                lobj_WorkCenter = new type_1.WorkCenter(cWorkCenter, this.schData);
            ...
            for (let drResource of this.schData.dtResource.rows) {
                ...
                lobj_Resource = new type_1.Resource(cResourceNo);
                ...
                if (lobj_Resource.bTeamResource !== '1') {
                    ...
                    for (let drResTimeRange of drResTime) {
                        lResTimeRange = new type_1.ResTimeRange();
    ...
    async getSchData() {
        ...
        try {
            ...
            schData.dtTechInfo.forEach((drTechInfo) => {
                ...
                lobj_TechInfo = new type_1.TechInfo(cTechNo, this.schData);
            ...
            schData.dtItem.forEach((drItem) => {
                ...
                lobj_Item = new type_1.Item(cInvCode, this.schData);
            ...
            schData.dtSchProductWorkItem.forEach((dr) => {
                let lSchProductWorkItem = new type_1.SchProductWorkItem();
                ...
                lSchProductWorkItem.dCanBegDate = dr.dCanBegDate ?? new type_1.DateTime();
            ...
            schData.dtSchProduct.forEach((dr) => {
                let lSchProduct = new type_1.SchProduct();
                ...
                lSchProduct.dEarliestSchDate = dr.dEarliestSchDate ?? new type_1.DateTime();
            ...
            schData.dtSchProductRoute.forEach((dr) => {
                let lSchProductRoute = new type_1.SchProductRoute();
            ...
            schData.dtSchProductRouteRes.forEach((dr) => {
                let lSchProductRouteRes = new type_1.SchProductRouteRes();
                ...
                if (lSchProductRouteRes.resource.FProChaType1ID != '-1' &&
                    ...
                    lSchProductRouteRes.resChaValue1 = new type_1.ResChaValue(lSchProductRouteRes.FResChaValue1ID, lSchProductRouteRes, 1);
                if (lSchProductRouteRes.resource.FProChaType2ID != '-1' &&
                    lSchProductRouteRes.resource.FProChaType2ID != '')
                    lSchProductRouteRes.resChaValue2 = new type_1.ResChaValue(lSchProductRouteRes.FResChaValue2ID, lSchProductRouteRes, 2);
                if (lSchProductRouteRes.resource.FProChaType3ID != '-1' &&
                    lSchProductRouteRes.resource.FProChaType3ID != '')
                    lSchProductRouteRes.resChaValue3 = new type_1.ResChaValue(lSchProductRouteRes.FResChaValue3ID, lSchProductRouteRes, 3);
                if (lSchProductRouteRes.resource.FProChaType4ID != '-1' &&
                    lSchProductRouteRes.resource.FProChaType4ID != '')
                    lSchProductRouteRes.resChaValue4 = new type_1.ResChaValue(lSchProductRouteRes.FResChaValue4ID, lSchProductRouteRes, 4);
                if (lSchProductRouteRes.resource.FProChaType5ID != '-1' &&
                    lSchProductRouteRes.resource.FProChaType5ID != '')
                    lSchProductRouteRes.resChaValue5 = new type_1.ResChaValue(lSchProductRouteRes.FResChaValue5ID, lSchProductRouteRes, 5);
                if (lSchProductRouteRes.resource.FProChaType6ID != '-1' &&
                    lSchProductRouteRes.resource.FProChaType6ID != '')
                    lSchProductRouteRes.resChaValue6 = new type_1.ResChaValue(lSchProductRouteRes.FResChaValue6ID, lSchProductRouteRes, 6);
            ...
            if (SchParam.cSelfEndDate == '1') {
                ...
                schData.dtSchProductRouteItem.forEach((dr) => {
                    let lSchProductRouteItem = new type_1.SchProductRouteItem();
    ...
    getSchProductRouteList(lSchProductRoute, arg1) {
        throw new Error('Method not implemented.');
    }
    async getSqlDataTable(query) {
        let table = new type_1.DataTable();
    ...
    // }
    //待实现
    dlShowProcess(schPrecent, message) {
        console.log(schPrecent + ' ' + message); //显示进度
    }
}
exports.SchInterface = SchInterface;
const createInteface = (input, datasource) => {
};
exports.createInteface = createInteface;
