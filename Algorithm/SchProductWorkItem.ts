...
import { DateTime, SchData, SchParam, SchProductRoute } from './type'

export class SchProductWorkItem extends Base{
  ...
  dRequireDate: DateTime // Required date
  dCanEndDate: DateTime // Latest delivery date
  dCanBegDate: DateTime // Earliest scheduling date
  dBegDate: DateTime // Scheduling start time
  dEndDate: DateTime // Scheduling end time
  dProductDate: DateTime // Product delivery date
  cSchStatus: string
  cMiNo: string
